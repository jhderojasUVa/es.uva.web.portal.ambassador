							...
							<c:if test="${paragraph.value.Image.exists}">
								<div class="col-md-12 col-sm-12 hidden-xs">
									<center style="margin-top: 0.5em;">
										<img src="<cms:link>${paragraph.value.Image.value.Image}</cms:link>" class="img-fluid" alt="${paragraph.value.Image.value.Title}" title="${paragraph.value.Image.value.Title}">
									</center>
								</div>
							</c:if>
